...
public class BookManagementAdapter extends RecyclerView.Adapter {
    private Context context;
    ArrayList<Book> list = new ArrayList<>();
    public BookManagementAdapter (Context ctx)
    {
        this.context = ctx;
    }
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position, Book e) {
        ...
        vh.cardView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i = new Intent(context, BookDeleteManagementActivity.class);
