...
public class AnnouncementRVAdapter extends RecyclerView.Adapter<AnnouncementVH> {
    ...
    public AnnouncementRVAdapter (Context ctx){this.context = ctx;}

    public void setItems(ArrayList<Announcement> announcements){announcementArrayList.addAll(announcements);}
